...
!pip install pdfminer        # for Python 2
...
text = ""
file_path = "/content/London-Resume-Template-Professional.pdf"  # Replace "your_pdf_file.pdf" with your actual PDF file path
...
def extract_text_from_doc(doc_path):
    temp = docx2txt.process("/content/Bold-Boaz-Resume.docx")
